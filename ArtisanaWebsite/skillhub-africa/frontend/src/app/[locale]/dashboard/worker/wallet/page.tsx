    ...
    <div className="min-h-screen bg-[#0f172a] text-gray-900">
      ...
      <main className="max-w-4xl mx-auto py-12 px-6 pt-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {/* Wallet Balance */}
          <div className="bg-white shadow-sm border border-gray-100 p-12 rounded-[3rem] border-secondary/20 relative overflow-hidden group">
          ...
          {/* Payout Form */}
          <div className="bg-white shadow-sm border border-gray-100 p-12 rounded-[3rem] border-gray-200">
            ...
            <form onSubmit={handlePayout} className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-gray-100 border border-gray-200 rounded-2xl p-4 text-gray-900 font-bold outline-none focus:border-secondary/50 transition-all"
                  placeholder="0.00"
                />
              </div>
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-gray-100 border border-gray-200 rounded-2xl p-4 text-gray-900 font-bold outline-none focus:border-secondary/50 transition-all appearance-none"
                >
