...
export default function KYCVerification() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-[#0f172a] text-gray-900 flex items-center justify-center p-6">
        <div className="text-center space-y-6 max-w-lg bg-white shadow-sm border border-gray-100 p-12 rounded-[3rem] border-secondary/20 shadow-2xl shadow-secondary/20">
          ...
          <Link href="/dashboard/worker" className="mt-8 block w-full py-4 bg-secondary rounded-2xl font-black uppercase tracking-widest text-[10px] text-gray-900 hover:bg-secondary/90 transition-all">
            {t.kyc?.returnDash}
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#0f172a] text-gray-900">
      ...
      <header className="bg-white shadow-sm border border-gray-100 sticky top-0 z-50 border-b border-gray-200 h-20">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="w-8 h-8 bg-blue-500 rounded-lg flex items-center justify-center font-black text-gray-900">V</div>
      ...
      <main className="max-w-3xl mx-auto py-16 px-6">
        <div className="mb-12 text-center">
          <div className="inline-block px-4 py-1 bg-white shadow-sm border border-gray-100 rounded-full text-[10px] font-black uppercase tracking-widest text-blue-400 mb-4 animate-pulse">
            {t.kyc?.moduleBadge}
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-sm border border-gray-100 p-8 md:p-12 rounded-[3rem] border-gray-200 space-y-8">
              ...
              {[
                ...
                <div 
                  ...
                  className={`cursor-pointer p-4 rounded-2xl border text-center transition-all ${
                    documentType === type.id ? 'border-blue-500 bg-blue-500/10 text-blue-400' : 'border-gray-200 bg-gray-100 text-gray-500 hover:border-white/20'
                  }`}
                >
          ...
          <div className="space-y-4">
            ...
            <label className="block w-full h-48 border-2 border-dashed border-gray-200 hover:border-blue-500/50 rounded-3xl bg-gray-100 flex flex-col items-center justify-center cursor-pointer transition-all">
          ...
          <div className="pt-4 border-t border-gray-200">
            <button 
              ...
              className="w-full py-5 bg-blue-600 text-gray-900 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-blue-500 transition-all shadow-xl shadow-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed group relative overflow-hidden"
            >
