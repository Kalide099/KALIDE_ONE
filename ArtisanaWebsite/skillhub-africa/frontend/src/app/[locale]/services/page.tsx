    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 pt-32 pb-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-20">
          <div className="inline-block px-4 py-1.5 bg-white shadow-sm border border-gray-100 rounded-full text-[10px] font-black uppercase tracking-[0.3em] text-secondary mb-6">
          ...
          <p className="text-gray-500 font-medium max-w-2xl mx-auto text-lg uppercase tracking-widest leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.id} className="group bg-white shadow-sm border border-gray-100 p-10 rounded-[3.5rem] border-gray-200 hover:border-secondary/40 transition-all duration-500 flex flex-col h-full hover:scale-[1.02]">
              ...
              <h3 className="text-2xl font-black uppercase tracking-tight mb-4 text-gray-900 group-hover:text-secondary transition-colors italic">
                {service.title}
              </h3>
              <p className="text-gray-500 text-sm font-medium leading-relaxed mb-10 flex-1">
                {service.desc}
              </p>
              
              <button 
                onClick={handleInitiate}
                className="w-full py-4 bg-white shadow-sm border border-gray-100 text-gray-900 rounded-2xl font-black uppercase tracking-widest text-xs group-hover:bg-secondary transition-all shadow-xl hover:shadow-secondary/20"
              >
