export default function WorkerProjects() {
  // Mock data
  const projects = [
    { id: 1, title: 'House Construction', status: 'in_progress', client: 'Client A', tasks: 5 },
    { id: 2, title: 'Plumbing Work', status: 'completed', client: 'Client B', tasks: 2 },
  ];
            ...
            {projects.map((project) => (
              <div key={project.id} className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-6">
                  ...
                  <div className="mt-2">
                    <span className="text-sm text-gray-500">Tasks: {project.tasks}</span>
                  </div>
                  <div className="mt-4">
                    <a
