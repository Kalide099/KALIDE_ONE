...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-900 flex flex-col items-center justify-center p-6 relative">
      <div className="hero-glow top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] opacity-10" />
      
      <div className="bg-white shadow-sm border border-gray-100 max-w-lg w-full p-10 rounded-[3rem] border-gray-200 relative z-10 shadow-2xl">
        ...
        {paymentStatus === 'success' ? (
          <div className="text-center space-y-6">
            ...
            <p className="text-gray-500 text-sm">Funds have been securely locked in Escrow.</p>
            <Link href="/dashboard/client" className="block w-full py-4 bg-secondary text-gray-900 rounded-xl font-black uppercase tracking-widest text-[10px] mt-8 hover:bg-secondary/80 transition-all">
              Return to Dashboard
            </Link>
          </div>
        ) : (
          <div className="space-y-6">
            <div className="bg-black/40 p-6 rounded-2xl border border-gray-200 space-y-4">
              ...
              <div className="flex justify-between text-sm border-t border-gray-200 pt-4">
                <span className="text-gray-500 font-black uppercase tracking-widest">Total Valuation</span>
            ...
            <button 
              ...
              disabled={isLoading}
              className="w-full py-5 bg-gradient-to-r from-secondary to-purple-600 hover:to-purple-500 text-gray-900 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-lg shadow-purple-500/20 disabled:opacity-50 transition-all relative overflow-hidden"
            >
