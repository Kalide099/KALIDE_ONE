  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-gray-900">
      ...
      <header className="bg-white shadow-sm border border-gray-100 sticky top-0 z-50 border-b border-gray-200 h-20">
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="w-8 h-8 rounded-lg bg-red-500 flex items-center justify-center font-black text-gray-900">
              ⚖
            </div>
      ...
      <main className="max-w-4xl mx-auto py-12 px-6 relative z-10 pt-32">
        ...
        <div className="bg-white shadow-sm border border-gray-100 rounded-[3rem] p-8 md:p-12 border-red-500/20 shadow-[0_0_30px_rgba(239,68,68,0.05)] relative overflow-hidden">
          {/* Header Info */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12 pb-8 border-b border-gray-200">
            ...
            <div>
              ...
              <p className="font-bold text-sm text-gray-900">{disputeData.escrowAmount}</p>
            </div>
            <div>
          ...
          <div className="mb-12">
            ...
            <div className="space-y-4 bg-black/40 p-6 rounded-3xl border border-gray-200">
          ...
          <div>
            ...
            <div className="relative h-4 bg-gray-100 rounded-full overflow-hidden flex mb-8">
              <div 
              ...
              {!isAccepted ? (
                <>
                  <button 
                    ...
                    className="flex-1 py-5 bg-red-500 hover:bg-red-400 text-gray-900 rounded-2xl font-black uppercase tracking-widest text-[10px] shadow-[0_0_20px_rgba(239,68,68,0.3)] transition-all"
                  >
                    {t.Justice?.accept}
                  </button>
